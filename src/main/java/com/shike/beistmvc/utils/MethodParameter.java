...
package com.shike.beistmvc.utils;
 ...
 *
 * <p>As of 4.2, there is a {org.springframework.core.annotation.SynthesizingMethodParameter}
...
public class MethodParameter {
        ...
        if (paramType == null) {
            if (this.parameterIndex < 0) {
                ...
                if (this.executable instanceof Constructor &&
                        !ClassUtil.isTopLevelClass(this.executable.getDeclaringClass()) &&
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return (getContainingClass() == otherParam.getContainingClass() &&
                ObjectUtil.equals(this.typeIndexesPerLevel, otherParam.typeIndexesPerLevel) &&
